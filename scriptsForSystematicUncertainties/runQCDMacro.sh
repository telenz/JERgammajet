...
for i in CODE/myDeclarations.h ; sed -i 's/const double etaBins\[nEtaBins+1\]={0.0,0.5,1.1,1.7,2.3};/const double etaBins\[nEtaBins+1\]={0.0,1.3,2.3};/g' "$i"
...
for i in CODE/myDeclarations.h ; sed -i 's/const double etaBins\[nEtaBins+1\]={0.0,1.3,2.3};/const double etaBins\[nEtaBins+1\]={0.0,0.5,1.1,1.7,2.3};/g' "$i"
# 5) Change alpha Binning
